...
conn = mysql.connector.connect(host='localhost', username='root', password='MCPsql@180499', database='CSSC')
cursor = conn.cursor()
...
def chi_square_test():
    ...
    cnx = mysql.connector.connect(user='root', password='MCPsql@180499',
